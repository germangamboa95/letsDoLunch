...
// Hide the share card on page load.
$(".shareCard").hide();

// Check if we are on a mobile in order to decide if we display the gps option.
if (mobilecheck()) {
  $('#geoButton').show();
}

// Event listener for the gps option.
    ...
    if (status === 'OK') {
      ...
      fetch('https://cors-anywhere.herokuapp.com/https://letshavelunchserver.herokuapp.com/api/session_start', {
        ...
        .then(data => {
          ...
          guestLink = "https://germangamboa95.github.io/letsDoLunch/Voting2.html?initiator=false&session=" + data;
